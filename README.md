...
// CDNs
import { createRovingTabIndex } from 'https://esm.sh/@y14e/roving-tabindex@<x.x.x>';
// or
import { createRovingTabIndex } from 'https://cdn.jsdelivr.net/npm/@y14e/roving-tabindex@<x.x.x>/+esm';
// or
import { createRovingTabIndex } from 'https://esm.unpkg.com/@y14e/roving-tabindex@<x.x.x>';
```
